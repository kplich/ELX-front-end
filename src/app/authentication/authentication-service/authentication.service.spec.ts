...
import {API_URL, AuthenticationService} from "@authentication/authentication-service/authentication.service";
...
describe("AuthenticationService logging in", () => {
    ...
    const USER_CREDENTIALS = {username: EXAMPLE_USER.username, password: "password"};
    ...
    xit("should save the token after successful login and remove it after logout",
        fakeAsync(() => {
            ...
            expect(loggedInUserService.authenticatedUser).toEqual(EXAMPLE_USER);
            expect(loggedInUserService.authenticatedUser).not.toEqual(null);
