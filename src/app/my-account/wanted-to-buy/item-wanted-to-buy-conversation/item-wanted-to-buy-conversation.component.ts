...
@Component({
    selector: "item-wanted-to-buy-conversation",
    templateUrl: "./item-wanted-to-buy-conversation.component.html",
    styleUrls: ["./item-wanted-to-buy-conversation.component.scss"]
})
export class ItemWantedToBuyConversationComponent {
