...
@Component({
    selector: "item-wanted-to-sell-conversation",
    templateUrl: "./item-wanted-to-sell-conversation.component.html",
    styleUrls: ["./item-wanted-to-sell-conversation.component.scss"]
})
export class ItemWantedToSellConversationComponent {
